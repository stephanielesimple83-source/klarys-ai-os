    ...
    <section className="space-y-4">
      <div>
        ...
        <p className="mt-1 text-sm text-slate-400">
          Les deux activit̩s sont suivies s̩par̩ment.
        </p>
      </div>
