    ...
    <div className="mx-auto max-w-[1600px] space-y-10">
      ...
      <section className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
        ...
        <StatCard
          ...
          subtitle={`${currentlyScheduledPercent} % des experts planifiÃ©s`}
          icon={CalendarDays}
        />

        <StatCard
          title="Heures planifiÃ©es"
      ...
      <Card className="border-cyan-500/20 bg-cyan-500/5 p-6">
        <p className="text-sm font-medium text-cyan-400">
          CEO AI â€” Analyse planning
        </p>

        <h2 className="mt-2 text-xl font-semibold text-white">
          Couverture de la journÃ©e
        </h2>
        ...
        <div className="mt-5 grid gap-4 lg:grid-cols-3">
          <div className="rounded-2xl border border-slate-800 bg-slate-950/30 p-4">
            ...
            <p className="mt-1 text-xs text-slate-500">
              experts actuellement planifiÃ©s
            </p>
          </div>
            ...
            <div className="flex items-start gap-3 rounded-2xl border border-amber-500/20 bg-amber-500/5 p-4">
              ...
              <div>
                ...
                <p className="mt-1 text-sm leading-6 text-slate-400">
                  Peu dâ€™experts sont planifiÃ©s aujourdâ€™hui. VÃ©rifie si la couverture correspond bien Ã  lâ€™activitÃ© attendue.
                </p>
              </div>
            </div>
          )}
            ...
            <div className="flex items-start gap-3 rounded-2xl border border-cyan-500/20 bg-cyan-500/5 p-4">
              ...
              <div>
                <p className="font-medium text-cyan-400">
                  Forte couverture cumulÃ©e
                </p>

                <p className="mt-1 text-sm leading-6 text-slate-400">
                  Le planning reprÃ©sente plus de 20 heures cumulÃ©es de prÃ©sence aujourdâ€™hui.
                </p>
              </div>
            </div>
          )}
          ...
          {!lowCoverage &&
            !longDay && (
              <div className="rounded-2xl border border-emerald-500/20 bg-emerald-500/5 p-4">
                ...
                <p className="mt-1 text-sm leading-6 text-slate-400">
                  Aucun signal particulier nâ€™est dÃ©tectÃ© sur la couverture actuelle.
                </p>
              </div>
            )}
        </div>
      ...
      <section>
        <div className="mb-5">
          ...
          <h2 className="mt-1 text-2xl font-semibold text-white">
            PrÃ©sence des experts
          </h2>

          <p className="mt-2 text-sm text-slate-400">
            Visualisation des crÃ©neaux rÃ©ellement rÃ©cupÃ©rÃ©s depuis Dialotel.
          </p>
        </div>
