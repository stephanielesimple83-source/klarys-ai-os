...
export default function CEODashboardCard({
  ...
  let recommendation =
    "L'activitÃ© est Ã©quilibrÃ©e entre le Cabinet et la Synergie.";

  if (cabinetShare < 25 && totalToday > 0) {
    recommendation =
      "Le Cabinet reprÃ©sente une faible part du chiffre dâ€™affaires aujourdâ€™hui. Il peut Ãªtre utile de renforcer les consultations Cabinet.";
  } else if (synergyShare < 25 && totalToday > 0) {
    recommendation =
      "La Synergie reprÃ©sente une faible part du chiffre dâ€™affaires aujourdâ€™hui. VÃ©rifie les disponibilitÃ©s et lâ€™activitÃ© des experts partenaires.";
  } else if (connectedExperts <= 2) {
    recommendation =
      "Peu dâ€™experts sont actuellement disponibles. Surveille la couverture du planning et les prochains crÃ©neaux.";
  }
        ...
        <div className="flex flex-col justify-between gap-6 xl:flex-row xl:items-start">
          <div>
            ...
            <p className="mt-2 max-w-2xl text-sm leading-6 text-slate-400">
              Analyse immÃ©diate du Cabinet, de la Synergie et de
              lâ€™activitÃ© opÃ©rationnelle.
            </p>
          </div>
